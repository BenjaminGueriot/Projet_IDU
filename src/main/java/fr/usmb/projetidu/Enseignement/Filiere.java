...
public enum Filiere {
	...
	IDU5("IDU5", "La meilleure filiere en fait mais pas jamais vu", new ArrayList<UE>()), SNI5("SNI5", "Les copieurs d'IDU v5", new ArrayList<UE>()), MM5("MM5", "mm5 !", new ArrayList<UE>()), DIPLOME("Diplomes", "Bravo à vous, vous etes diplomes", new ArrayList<UE>());
